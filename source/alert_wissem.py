    ...
    try:
        ...
        while True:
            ...
            try:
                for trader in tradersList:      
                    ...
                    with   urllib.request.urlopen(getTradesApi) as jsonTrades:
                        ...
                        for actualTrade in data :       
                            ...
                            lastTradeTime=datetime.fromtimestamp(int(lastTrade.occuredAt/1000.0)) # need it to track time
                ...
                print("Exception {} caught while getting and analysing data".format(ex))
                continue
    except:
